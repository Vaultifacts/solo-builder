...
import { pollHistory, historyPageStep, pollBranches, pollSettings, pollPriority, pollStalled, pollSubtasks, pollAgents, pollForecast, pollMetrics, pollCache, pollCacheHistory, pollHealthDetailed, pollGatesDetailed } from "./dashboard_panels.js";
...
async function tick() {
  ...
  await Promise.all([pollStatus(), pollTasks(), pollJournal(), pollDiff(), pollStats(), pollHistory(), pollBranches(), pollSettings(), pollPriority(), pollStalled(), pollSubtasks(), pollAgents(), pollForecast(), pollMetrics(), pollCache(), pollCacheHistory(), pollHealth(), pollHealthDetailed(), pollGatesDetailed(), progressPoll]);
